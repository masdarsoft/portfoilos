...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
      ...
      <body className="min-h-full flex flex-col font-sans bg-bg-soft text-text-dark antialiased" style={{ fontFamily: "var(--font-tajawal), sans-serif" }}>
        ...
        {/* Pulsing WhatsApp FAB (visible on all screen sizes, stacked above Call FAB) */}
        <a
          ...
          className="fixed z-50 bottom-44 left-6 md:bottom-24 md:left-8 flex items-center justify-center w-14 h-14 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-2xl transition-all duration-300 hover:scale-110 group cursor-pointer"
        ...
        {/* Pulsing Call FAB (visible on all screen sizes, positioned at bottom of stack) */}
        <a
          href={`tel:${phoneNum}`}
          className="fixed z-50 bottom-28 left-6 md:bottom-8 md:left-8 flex items-center justify-center w-14 h-14 bg-gold-accent hover:bg-gold-light text-plum-primary rounded-full shadow-2xl transition-all duration-300 hover:scale-110 group cursor-pointer"
          aria-label="اتصال هاتفي مباشر"
        >
          <span className="absolute inset-0 rounded-full bg-gold-accent/30 animate-ping group-hover:hidden" />
          <Phone className="w-6 h-6 text-plum-primary fill-plum-primary" />
        </a>
